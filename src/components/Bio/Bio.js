...
import { ButtonFront, SectionDivider, SectionText } from '../../styles/GlobalComponentsStyles/globalC';
    ...
    return (
        <Section>
            ...
            <SectionContent>
                <PContent>
                    ...
                    {lang === "fr"
                        ...
                        <p>
                            <br />
                            Passionné par les nouvelles Technologies et la création d'Application depuis mon adolescence. <br />
                            <br />
                            Aujourd'hui, je code en C++, React/Nextjs et Javascript des projets en équipes ou en solo que je poste sur Github. <br />
                            <br />
                        </p>
                        :
                        <p>
                            <br />
                            Since I was a teenager, I've always been fascinated by new technologies and the process of creating applications.<br />
                            <br />
                            Today, I code in C++,  React/Nextjs and Javascript, projects with a team or at Home, which I post on Github.<br />
                            <br />
                        </p>
                    }
                    <SectionDivider />
            ...
            <SectionContent >
                    <PContent >
                        <p>
                        {Personnal_Info.Contact.adress + ","}<br />
                        {Personnal_Info.Contact.city + " " + Personnal_Info.Contact.postal_code}<br />
                        {Personnal_Info.Contact.phone}<br />
