...
export default function App({ Component, pageProps }) {
  ...
  useEffect(() => {
    ...
    const prefersDark =
      window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches; // Check user pref.
  ...
  return (
    <>
      <Head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Lato:wght@300&family=Oxygen:wght@300&display=swap"
          rel="stylesheet"
        />
